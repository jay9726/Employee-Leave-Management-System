...
import EmployeeHolidays from "@/modules/hoilday/pages/employee-holiday";
import EmployeeDepartment from "@/modules/department/pages/employee-department";
...
const router = createBrowserRouter([
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: "department", element: withSuspense(<DepartmentList />) },
              { path: "department/add", element: withSuspense(<AddDepartment />) },
              { path: "department/update/:id", element: withSuspense(<UpdateDepartment />) },
              { path: "leave-request/update", element: withSuspense(<UpdateLeaveRequest />) },
              { path: "employee", element: withSuspense(<EmployeeList />) },
              { path: "employee/add", element: withSuspense(<AddEmployee />) },
              { path: "employee/update/:id", element: withSuspense(<UpdateEmployee />) },
              { path: "holidays", element: withSuspense(<CompanyHolidayList />) },
              { path: "holidays/add", element: withSuspense(<AddHoliday />) },
              { path: "holidays/update/:id", element: withSuspense(<UpdateHoliday />) },
      ...
      {
        path: "employee",
        element: <ProtectedRoute AllowRole={['Employee']} />,
        errorElement: withSuspense(<ErrorPage />),
        children: [
          {
            element: withSuspense(<EmployeeLayout />),
            children: [
              { index: true, element: withSuspense(<EmployeeHomePage />) },
              { path: "leave-request", element: withSuspense(<LeaveRequestList />) },
              { path: "holidays", element: withSuspense(<EmployeeHolidays />) },
              { path: "department", element: withSuspense(<EmployeeDepartment />) },
              { path: "profile", element: withSuspense(<Profile />) },
              { path: "changepassword", element: withSuspense(<ChangePassword />) },
            ]
          },
        ]
      }
