...
import { Home, Building, Calendar, ChevronLeft, Menu, BookAIcon, Users, } from "lucide-react";
...
const AdminSlider: React.FC = () => {
    ...
    const navLinks = [
        ...
        { path: "/admin/department", icon: Building, label: "Departments" },
        { path: "/admin/holidays", icon: Calendar, label: "Holidays" },
        { path: "/admin/leave-request/update", icon: BookAIcon, label: "Update Leave" },
    ];
