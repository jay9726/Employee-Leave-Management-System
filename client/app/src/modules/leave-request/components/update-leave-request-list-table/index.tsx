...
import UpdateLeaveRequestForm from '../update-leave-request-form';
...
const UpdateLeaveRequestListTable: React.FC<updateLeaveRequestListTableProps> = ({ data }) => {
    ...
    return (
        <>
            ...
            {openModal && (
                <UpdateLeaveRequestForm appAndLeaveId={appAndLeaveId} setOpenModal={() => setOpenModal(false)} />
            )}
        </>
    )
}
